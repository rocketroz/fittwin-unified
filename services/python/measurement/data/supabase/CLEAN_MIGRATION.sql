-- ============================================================================
-- FITTWIN UNIFIED PLATFORM - CLEAN DATABASE MIGRATION
-- ============================================================================
...
DROP POLICY IF EXISTS "Users can view own sessions" ON measurement_sessions;
DROP POLICY IF EXISTS "Users can insert own sessions" ON measurement_sessions;
